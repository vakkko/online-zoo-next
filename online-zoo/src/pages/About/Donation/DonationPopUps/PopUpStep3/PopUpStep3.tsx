  ...
  return (
    <div className="donation-pop-up-step-3">
      ...
      <div>
        ...
        <div id="save-card-checkbox" className="hidden">
          <input type="checkbox" id="save-card" />
          <label htmlFor="save-card">Save card info for future donations</label>
        </div>
        <div className="select-container saved-card hidden">
          <select name="saved-cards" id="saved-cards">
            <option value="" hidden>
              Saved Card
            </option>
          </select>
